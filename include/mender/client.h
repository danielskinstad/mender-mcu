...
typedef struct {
    ...
    uint32_t backoff_interval;          /**< Backoff interval for retries on net errors , default is compile-time defined */
    uint32_t max_backoff_interval;      /**< Max backoff interval for retries on net errors, default is compile-time defined */
